...
setwd("C:/telerilevamento_exam/vaia_crop") # Windows
...
prevaia2018res <- brick(vimport2018[[4]], vimport2018[[3]], vimport2018[[2]])

vlist2019 <- list.files(pattern="T32TPS_2019")
vimport2019 <- lapply(vlist2019, raster)
postvaia2019res <- brick(vimport2019[[4]], vimport2019[[3]], vimport2019[[2]])
...
ggpcir2018 <- ggRGB(prevaia2018res, 1, 2, 3, stretch="lin")
ggpcir2019 <- ggRGB(postvaia2019res, 1, 2, 3, stretch="lin")

ggpcir2018 + ggpcir2019

dvi2018 = prevaia2018res[[1]] - prevaia2018res[[2]]
dvi2019 = postvaia2019res[[1]] - postvaia2019res[[2]]
...
ndvi2018 = dvi2018 / (prevaia2018res[[1]] + prevaia2018res[[2]])
ndvi2019 = dvi2019 / (postvaia2019res[[1]] + postvaia2019res[[2]])
